...
def read_edgelist_csv(fname, 
    ...
    if continuous:
        load_continuous_edgelist(fname, cols_to_read, time_intervals=1, header=header)
    elif data is None:
        load_discrete_edgelist(fname, cols_to_read, header=header)
    

    # if return_csv:
    #     return csv_loader(fname, sep, header,
    #                       [u_col, v_col, t_col, weight_col, feat_col],
    #                       reindex_nodes, weight, edge_feat, feat_size=feat_size)
...
if __name__ == "__main__":
    ...
    # print(a)
    read_edgelist_csv("/network/scratch/r/razieh.shirzadkhani/data/Contacts/Contacts.csv",
